...
Revision ID: c860b8dd34ab
Revises: 20648f384068
Create Date: 2020-01-20 12:58:00.781573
...
revision = 'c860b8dd34ab'
down_revision = '20648f384068'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('co_maker_1_id', sa.Integer(), nullable=False),
    sa.Column('co_maker_2_id', sa.Integer(), nullable=False),
